      ...
      <div className="auth-brand-panel">
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <div className="mt-10 rounded-2xl border border-white/10 bg-white/5 px-6 py-4 backdrop-blur-sm">
            ...
            <p className="mt-1 text-xs text-white/40">Restricted to authorized administrators</p>
          </div>
        </div>
      </div>
      ...
      <div className="auth-form-panel">
        <div className="w-full max-w-md">
          ...
          <div className="mb-6 md:mb-8">
            ...
            <h2 className="font-display text-2xl font-semibold text-foreground md:text-3xl">Admin Portal</h2>
            <p className="mt-1.5 text-sm text-muted-foreground">Sign in to access the admin control panel.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="h-12 w-full rounded-xl text-[15px] font-semibold" disabled={!password || loading}>
